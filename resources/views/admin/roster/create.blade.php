		...
		<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 col-sm-offset-3 col-md-offset-3 col-lg-offset-3">
			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
    				...
    				{!! Form::select('team', ['' => 'Please Select A Team'] + $teams->lists('name', 'id')->all(), [], array('class'=>'form-control select2', 'data-fv-notempty' => 'true', 'id' => 'team_select')) !!}
    				</div>
    			</div>
    		</div>
    		<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
    				...
    				{!! Form::select('players[]', $players->lists('alias', 'id')->all(), [], array('class'=>'form-control select2', 'multiple' => 'multiple', 'data-fv-notempty' => 'true', 'id' => 'player_select')) !!}
    				</div>
    			</div>
    		</div>
			<div class="row">
