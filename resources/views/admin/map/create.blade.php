...
@endsection
@section('content')
	{!! Form::open(array('action'=>'MapController@store', 'class'=>'form-login', 'id' => 'form')) !!}
	<div class="row">
		<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 col-sm-offset-3 col-md-offset-3 col-lg-offset-3">
			<div class="row form-top">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					<h4 class="text">Create Map</h4>
				</div>
			</div>
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					<div class="form-group">
					{!!Form::label('map_name', 'Map Name')!!}
					{!! Form::text('map_name', '' , array('class'=>'form-control', 'placeholder'=>'Map Name', 'data-fv-notempty' => 'true')) !!}
					</div>
				</div>
			</div>
    		<div class="row">
