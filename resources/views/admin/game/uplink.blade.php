...
@yield('specialist')
      ...
      <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
        <input type="text" name="a_uplink_score" class="form-control" value={!!$mode->team_a_score!!}>
      </div>
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
          ...
          <tbody>
            @for($i = 1; $i <= 4; $i++)
              <tr>
                ...
                <td>{!! Form::text('carries[]', $ascores[$i-1]->carries , ['class'=>'form-control']) !!}</td>
                <td>{!! Form::text('throws[]', $ascores[$i-1]->throws , ['class'=>'form-control']) !!}</td>
