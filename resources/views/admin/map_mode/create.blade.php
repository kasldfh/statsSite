		...
		<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 col-sm-offset-3 col-md-offset-3 col-lg-offset-3">
			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					{!!Form::label('map', 'Map')!!}
    				{!! Form::select('map', ['' => 'Please Select A Map'] + $maps->lists('name', 'id')->all(), [], array('class'=>'form-control', 'data-fv-notempty' => 'true')) !!}
    				</div>
    			</div>
    		</div>
    		<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
    				...
    				{!! Form::select('mode', ['' => 'Please Select A Mode'] + $modes->lists('name', 'id')->all(), [], array('class'=>'form-control', 'data-fv-notempty' => 'true')) !!}
    				</div>
    			</div>
    		</div>
    		<div class="row">
