		...
		<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 col-sm-offset-3 col-md-offset-3 col-lg-offset-3">
			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
    				...
    				{{ Form::select('event', ['' => 'Please Select An Event'] + $events->lists('name', 'id'), [], array('class'=>'form-control', 'data-fv-notempty' => 'true')) }}
    				</div>
    			</div>
    		</div>
    		<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
    				...
    				{{ Form::select('team_a', ['' => 'Please Select Team A'] + $teams->lists('name', 'id'), [], array('class'=>'form-control', 'data-fv-notempty' => 'true')) }}
    				</div>
    			</div>
    		</div>
    		<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
    				...
    				{{ Form::select('team_b', ['' => 'Please Select Team B'] + $teams->lists('name', 'id'), [], array('class'=>'form-control', 'data-fv-notempty' => 'true')) }}
    				</div>
    			</div>
    		</div>
    		<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
    				...
    				{{ Form::select('match_type', ['' => 'Please Select An Match Type'] + $match_types->lists('name', 'id'), [], array('class'=>'form-control', 'data-fv-notempty' => 'true')) }}
    				</div>
    			</div>
    		</div>
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    ...
                    {{ Form::select('score_type', ['' => 'Please Select A Score Type'] + $score_types->lists('name', 'id'), [], array('class'=>'form-control', 'data-fv-notempty' => 'true', 'id' => 'score_type')) }}
                    </div>
                </div>
            </div>
