		...
		<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 col-sm-offset-3 col-md-offset-3 col-lg-offset-3">
			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
    				...
    				{!! Form::select('event_type', ['' => 'Please Select An Event Type'] + $event_types->lists('name', 'id')->all(), [], array('class'=>'form-control', 'placeholder'=>'Event Name', 'data-fv-notempty' => 'true')) !!}
    				</div>
    			</div>
    		</div>
    		<div class="row">
